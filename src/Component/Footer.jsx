...
function Footer() {
  return (
    <div className='bg-main2 text-black w-full md:h-[10vh] py-4 md:py-0 items-center md:flex '>
        ...
        <div className='text-sm justify-center md:justify-start w-full md:text-lg  md:text-left px-8 h-full items-center flex '>Copyright 2025 All Right Reserved </div>
        </div>
